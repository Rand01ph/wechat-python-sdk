...
class WechatBasic(WechatBase):
    ...
    def add_material_news(self, news):
        """
        新增永久素材
        详情请参考
    ...
    def update_material_news(self, media_id, index, news):
        """
        修改永久素材
        详情请参考
        http://mp.weixin.qq.com/wiki/14/7e6c03263063f4813141c3e17dd4350a.html
    ...
    def batchget_material(self, media_type, offset=0, count=20):
        """
        批量获取永久素材列表
        详情请参考
